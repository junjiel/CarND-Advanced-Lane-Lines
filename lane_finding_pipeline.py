...
def draw_line(warped, left_fitx, right_fitx, ploty, Minv):
...
out_img, left_fit, right_fit, left_fitx, right_fitx, ploty= fit_polynomial(warped_binary)
...
drwalines = draw_line(warped_binary,left_fitx,right_fitx,ploty,Minv)
plt.figure()
plt.imshow(drwalines)
